...
android {
    ...
    defaultConfig {
        applicationId = "ai.webwaifu.mobile"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "0.1.0"
...
dependencies {
    ...
    // Temporary native material compiler while the MToon port is stabilized. Release builds can
    // replace this with the architecture-neutral .filamat packages produced by matc 1.52.0.
